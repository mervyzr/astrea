...
def evolveSpace(tube, _simVariables):
    if _simVariables.subgrid in ["weno", "w"]:
        return weno.run(tube, _simVariables)
    elif _simVariables.subgrid in ["ppm", "parabolic", "p"]:
        #return ppm.runModified(tube, _simVariables, dissipate=False)
        return ppm.run(tube, _simVariables)
    elif _simVariables.subgrid in ["plm", "linear", "l"]:
        return plm.run(tube, _simVariables)
    else:
