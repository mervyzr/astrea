...
# Reconstruct the interpolants
def reconstruct(extrapolatedValues, limitedValues, solver):
    # Reconstruction of parabolic interpolant; preserves behaviour at smooth-extrema (XPPM) [Peterson & Hammett, 2013]
    if solver in ["ppm", "parabolic", "p"]:
        C = 5/4
        ...
        # Reconstruction of limited parabolic interpolant [Colella et al., 2011]
        else:
