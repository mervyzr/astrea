...
def evolveSpace(tube, gamma, subgrid, solver, boundary):
    ...
    return solvers.calculateRiemannFlux(tube, solutions, gamma, subgrid, solver, boundary)


# Evolve the system in time by a standardised workflow
def evolveTime(domain, fluxes, dx, dt, timestep, gamma, subgrid, solver, boundary):
    Lq0 = getL(fluxes, dx)
