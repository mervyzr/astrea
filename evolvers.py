...
def evolveSpace(tube, gamma, subgrid, scheme, boundary):
    ...
    return solvers.calculateRiemannFlux(tube, solutions, gamma, subgrid, scheme, boundary)


# Evolve the system in time by a standardised workflow
def evolveTime(domain, fluxes, dx, dt, timestep, gamma, subgrid, scheme, boundary):
    Lq0 = getL(fluxes, dx)
