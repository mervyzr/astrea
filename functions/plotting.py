...
def make_figure(options, sim_variables, variable="normal"):
    if 0 < len(options) < 15:
        ...
        cmap_colours = {
            ...
            "mass": "gist_earth",
            "schlieren": "gray",
            "velocity": {"x":"Spectral", "y":"RdYlGn", "z":"RdYlBu"},
            "momentum": {"x":"RdBu", "y":"RdGy", "z":"PuOr"},
            "Bfield": {"x":"BrBG", "y":"PRGn", "z":"PiYG"},
        }
        ...
        if sim_variables.config_category == "smooth" or ("sod" in config or "sedov" in config):
            ...
            # Add smooth analytical solution (1D, 2D, 3D)
                ...
                if "manufacture" in config or "euler" in config:
                    ...
                    analytical = ginit.initialise(sim_variables)
