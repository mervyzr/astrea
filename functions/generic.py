...
ACCEPTED_VALUES = {
    "config": ["sod", "sin", "sin-wave", "sedov", "shu-osher", "shu", "osher", "slow", "slow-moving shock", "slow shock", "gaussian", "gauss", "sq", "square", "square-wave", "ryu-jones", "ryu", "jones", "rj", "brio-wu", "brio", "wu", "bw", "khi", "kelvin", "helmholtz", "kelvin-helmholtz", "ivc", "vortex", "isentropic vortex", "toro1", "toro2", "toro3", "toro4", "toro5", "ll3", "ll4", "ll6", "ll11", "ll12", "ll15", "lax-liu3", "lax-liu4", "lax-liu6", "lax-liu11", "lax-liu12", "lax-liu15"],
    "dimension": [1, 1.5, 2],
