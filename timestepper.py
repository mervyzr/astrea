...
def evolveTime(shockTube, dt, fluxes, stepper):
    ...
    if stepper == "ssprk(5,4)":
        # Evolve system by SSP-RK (5,4) method (4th-order)
        ...
        # Evolve system by SSP-RK (3,3) method (3rd-order)
        # Computation of 1st register
        ...
        # Evolve system by SSP-RK (4,3) method (3rd-order)
        # Computation of 1st register
        ...
        # Evolve the system by RK4 method (4th-order)
        # Computation of 1st register
        k1 = shockTube.domain + .5*dt*Lq0
